...
<div><a class="trace" href="/ranked-strategies.html" target="_blank" rel="noopener">新页签打开资金曲线排名</a><div class="muted">自动刷新 · UTC {updated}</div></div></header><div class="status">{html.escape(gate)}</div>
